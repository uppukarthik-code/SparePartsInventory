...
LINEAGE = [
    ...
    ("railway_operational_inventory.csv", "SUMMARY OF STOCK HELD*.xlsx (per-division)", "Operational", "railway_operational_analysis.py"),
    ("operational_data_quality.csv", "SUMMARY OF STOCK HELD*.xlsx (per-division)", "Operational", "railway_operational_analysis.py"),
